...
TEST(Registro, CercaConData) {
    ...
    EXPECT_EQ(*risultati[0],
              Attivita("Calcio", GiornoDelCalendario(1, 12, 2000), 0, "No", Orario(12, 11), Orario(13, 10)));
    EXPECT_EQ(*risultati[1],
              Attivita("Basket", GiornoDelCalendario(1, 12, 2000), 1, "No", Orario(12, 11), Orario(13, 10)));
}
...
TEST(Registro, CercaConNome) {
    ...
    EXPECT_EQ(*risultati[0],
              Attivita("Calcio", GiornoDelCalendario(1, 12, 2000), 0, "No", Orario(12, 11), Orario(13, 10)));
    EXPECT_EQ(*risultati[1],
              Attivita("Calcio", GiornoDelCalendario(1, 12, 2020), 1, "No", Orario(12, 11), Orario(13, 10)));
}
